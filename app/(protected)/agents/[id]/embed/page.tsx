...
export default function EmbedPage() {
  ...
  const embedCode = useMemo(
    () => `<script src="${siteUrl}/widget.js?agent=${currentAgent.id}"></script>`,
    [currentAgent.id, siteUrl]
  )
        ...
        <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
          ...
          <div className="space-y-4">
            <Card>
              <CardHeader className="flex flex-row items-start gap-3">
                ...
                <div className="space-y-1">
                  <CardTitle>Sådan installerer du</CardTitle>
                  <CardDescription>
                    Hurtige trin for en stabil installation
                  </CardDescription>
                </div>
              </CardHeader>
              <CardContent className="space-y-3 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  <p>
                    Indsæt scriptet lige før {`</body>`} på alle sider, hvor widgetten skal vises.
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="mt-1.5 size-2.5 rounded-full bg-primary" />
                  <p>
                    I Next.js/React: brug {`<Script strategy="lazyOnload">`} eller læg koden i din globale layout.
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="mt-1.5 size-2.5 rounded-full bg-primary" />
                  <p>
                    Tjek at adblockere ikke fjerner scriptet, og at domænet matcher dit CORS-setup.
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="mt-1.5 size-2.5 rounded-full bg-primary" />
                  <p>
                    Klik “Se demo-side” eller “Åbn chat” for at validere efter deploy.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="flex flex-row items-start gap-3">
                <div className="flex size-9 items-center justify-center rounded-lg bg-primary/10 text-primary">
                  <HugeiconsIcon icon={CodeCircleIcon} size={18} />
                </div>
                <div className="space-y-1">
                  <CardTitle>SPA/Next.js snippet</CardTitle>
                  <CardDescription>
                    Eksempel med Next.js Script-komponent
                  </CardDescription>
                </div>
              </CardHeader>
              <CardContent className="space-y-3 text-sm">
...
export function ChatWidgetEmbed() {
  return (
    <Script
      src="${siteUrl}/widget.js?agent=${currentAgent.id}"
      strategy="lazyOnload"
    />
  )
}`}
                ...
                <p className="text-muted-foreground">
                  Placer komponenten i din layout eller i en root-provider, så scriptet kun loades én gang.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="flex flex-row items-start gap-3">
                ...
                <div className="space-y-1">
                  <CardTitle>Tjekliste</CardTitle>
                  <CardDescription>Bekræft før go-live</CardDescription>
                </div>
              </CardHeader>
              <CardContent className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  <HugeiconsIcon icon={Tick02Icon} size={16} className="text-success" />
                  <span>Widget-knappen vises på alle relevante sider</span>
                </div>
                <div className="flex items-center gap-2">
                  <HugeiconsIcon icon={Tick02Icon} size={16} className="text-success" />
                  <span>Ingen JS-fejl i konsollen efter load</span>
                </div>
                <div className="flex items-center gap-2">
                  <HugeiconsIcon icon={Tick02Icon} size={16} className="text-success" />
                  <span>Branding matcher farver/logo i indstillinger</span>
                </div>
              </CardContent>
            </Card>
          </div>
